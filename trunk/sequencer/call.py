...
connect to sequencer, make outgoing call[, play sample] and hangup

$Id: client.py 137 2004-05-02 23:56:35Z lars $
"""
...
class Call:
    ...
    def __init__(self, sequencer):
        ...
        self.sequencer.send(self, 'CONN any 32 30000 41') 
    ...
    def CONN(self, event, user_data):
        self.device = event['device']
        self.send('MLCA %s 0 2 1 beep 1 none play ../test/phone/sitrtoot.al none' % self.device)        
