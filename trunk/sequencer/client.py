...
$Id: client.py,v 1.17 2003/12/17 23:27:21 lars Exp $
"""
...
class Call:
    ...
    def ACPT(self, event, data):
        self.send('MLCA %s 2 1 play ../test/phone/sitrtoo none'
                  % self.device)
##         self.send('MLCA %s 2 1 beep 2'
##                   % self.device)
##         self.send('MLCA %s 2 1 rec foo 10000'
##                   % self.device)
